// src/app/[locale]/centre/page.tsx
...
export const metadata: Metadata = { title: 'Acutis Centre' };

export default async function CentrePage({ params: { locale } }: Props) {
  const line: ProductLinePage | null = await client.fetch(PRODUCT_LINE_BY_SLUG_QUERY, { slug: 'acutis-centre' });
        ...
        <section className="section-pad">
          <div className="container-site">
            ...
            <h2 className="font-serif text-2xl md:text-3xl text-primary-800 mb-8">
              {locale === 'ie' ? 'Cad atá san áireamh in Acutis Lár' : "What's included in Acutis Centre"}
            </h2>
